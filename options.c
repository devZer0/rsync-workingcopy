...
static struct poptOption long_options[] = {
  ...
  {"omit-link-perms",  0,  POPT_ARG_VAL,    &omit_link_perms, 1, 0, 0 },
  ...
  {"time-format",      0,  POPT_ARG_STRING, &time_format, 0, 0, 0 },
  {"log-time-format",  0,  POPT_ARG_STRING, &log_time_format, 0, 0, 0 },
